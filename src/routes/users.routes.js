...
import { createNewConnection, getFollowers, getFollowing, getProfileData, getProfileVisitorData, getUsers, searchUsers } from "../controllers/users.cotrollers.js"
...
import { newPostSchema, searchSchema } from "../schemas/users.schemas.js"
...
usersRouter.post("/users/search", validateUserHeader, validateSchema(searchSchema), searchUsers)
